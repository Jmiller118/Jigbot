# Track the dot, cvt to BW to reduce error, draw circle around target
...
while True:
	...
	if len(cnts) > 0:
		...
		if radius > 10:
			...
			# center is the center of mass of the bouding polygone
			...
			#print(" x  , y  , rad, center")
			#print(int(x), int(y), int(radius), center)
			print("angle is : ", angle, 180/ pi * angle) 
						

	# update the points queue, aka draw a tail
